...
jQuery.fn.addSortWidget = function(options){
	var defaults = {
		img_asc: "images/icons/sort/asc_sort.svg",
    img_desc: "images/icons/sort/desc_sort.svg",
		img_nosort: "images/icons/sort/no_sort.svg",
	};
	...
	$(".js-sorting", $destElement).each(function(index){ // to each header cell (index is useful while sorting)
